...
public class CityListAdapter extends RecyclerView.Adapter<CityListAdapter.BaseViewHolder> {
    ...
    private List<HotCityBean> mHotData;
    private int locateState;
    private InnerListener mInnerListener;
    private LinearLayoutManager mLayoutManager;
    private boolean stateChanged;

    public CityListAdapter(Context context, List<CityBean> data, List<HotCityBean> hotData, int state) {
        this.mData = data;
    ...
    public void updateData(List<CityBean> data) {
        this.mData = data;
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        ...
        if (holder instanceof DefaultViewHolder) {
            ...
            final CityBean data = mData.get(pos);
            if (data == null) return;
            ((DefaultViewHolder) holder).name.setText(data.areaName);
        ...
        if (holder instanceof LocationViewHolder) {
            ...
            switch (locateState) {
                ...
                case LocateState.SUCCESS:
                    ((LocationViewHolder) holder).current.setText(data.areaName);
                    break;
