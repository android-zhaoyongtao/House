package house.shen.com.house.customview;
...
public class RentDialog extends Dialog {
    //一个确定按钮的
    public RentDialog(Activity activity, String title, String message, String posiText, final View.OnClickListener posi) {
        this(activity, title, message, false, null, null, posiText, posi);
    }

    //两个确定取消按钮的
    public RentDialog(Activity activity, String title, String message, String negeText, final View.OnClickListener nega, String posiText, final View.OnClickListener posi) {
        this(activity, title, message, true, negeText, nega, posiText, posi);
    }

    private RentDialog(Activity activity, String title, String message, boolean showNegaButton, String negeText, final View.OnClickListener nega, String posiText, final View.OnClickListener posi) {
